...
run.bat
6. اگر مدل spacy را نتوانستید دانلود کنید و موقع اجرای setup.bat ارور گرفتید، میتوانید مدل را از لینک زیر دستی دانلود کنید و extract کرده و آن را درون پوشه پروژه کپی کنید.
